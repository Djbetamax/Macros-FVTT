main ()
  ...
  //Cria a inspiração
      const cItem = game.items.getName("ITEMNAME");
      let item = getActor.items.find(item => item.data.name=="ITENNAME")
    ...
    //Manda a mensagem no chat
        ...
        let chatContent = `<h2>Recebe Inspiração</h2>`+`<h3>O mestre está dando uma @Item[ITEMNAME] para ${getActorName}.</h3> Tem ${getLeftItem} de 3 inspirações máximas.`
          ChatMessage.create ({
            speaker: "Mestre",
              content: chatContent 
        })
    ...
    //Adcionar inspiração
      ...
      //Mensagem no chat2
        ...
        let chatContent2 = `<h2>Recebe Inspiração</h2>`+ `<h3>O mestre está dando uma @Item[ITEMNAME] para ${getActorName2}.</h3> Tem ${getLeftItem2} de 3 inspirações máximas.`
          ChatMessage.create ({
            speaker: "Mestre",
